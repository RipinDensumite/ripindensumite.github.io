            ...
            <div className="max-w-xl mx-auto border border-gray-300 rounded-lg shadow-lg p-6 bg-gradient-to-br from-slate-50 to-slate-200">
                ...
                <div className="mt-4 grid grid-cols-2 gap-4">
                    ...
                    <div className="col-span-2 ml-auto space-x-1">
                        ...
                        <button onClick={() => window.open("https://github.com/RipinDensumite/")} className="size-8 hover:bg-zinc-300 transition-all rounded-lg">
                        ...
                        <button onClick={() => window.open("https://www.linkedin.com/in/arifin-densumite/")} className="size-8 hover:bg-zinc-300 transition-all rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50">
